export const API_CONFIG = {
  newsApi: {
    ...
    apiKey: process.env.REACT_APP_NEWSAPI_KEY || 'demo_key_newsapi',
    endpoints: {
  ...
  guardian: {
    ...
    apiKey: process.env.REACT_APP_GUARDIAN_KEY || 'demo_key_guardian',
    endpoints: {
      search: '/search',
      sections: '/sections'
    }
  ...
  nyTimes: {
    ...
    apiKey: process.env.REACT_APP_NYTIMES_KEY || 'demo_key_nytimes',
    endpoints: {
